      ...
      items.add(ExpansionTile(
        ...
        children: [
          ListTile(
           ...
           ListTile(
            leading: Icon(Icons.app_registration, color: Color(0xFF773697), size: 15.0),
            title: Text('New Employee', style: TextStyle(fontSize: 12.0)),
            onTap: () {
              Navigator.pushReplacementNamed(context, '/add_new_employee');
            },
          ),
          
          ListTile(
            leading: Icon(Icons.account_box, color: Color(0xFF773697), size: 15.0),
            title: Text('New Account Manager', style: TextStyle(fontSize: 12.0)),
            onTap: () {
          ...
          ListTile(
            ...
            title: Text('New HR Manager', style: TextStyle(fontSize: 12.0)),
            onTap: () {
